...
<body class="font-sans bg-gray-900 text-white">
    ...
    <div class="flex items-center">
        <div class="relative mt-3 md:mt-0">
            <input type="text" class="bg-gray-800 rounded-full w-64 px-4 pl-8 py-1 text-sm focus:outline " placeholder="Search">
